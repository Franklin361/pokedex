...
export const getPokemonByName = async (name = '') => {
  ...
  const pokemon = {
    ...
    front_default: responseData.sprites?.front_default,
    back_default: responseData.sprites?.back_default,
    front_shiny: responseData.sprites?.front_shiny,
    back_shiny: responseData.sprites?.back_shiny,
