...
export const PokemonItemDrawer = ({ pokemon }) => {
  ...
  return (
    <div className='border-2 border-black rounded-md p-5 sm:grid sm:grid-cols-[100px,1fr] sm:gap-10 flex flex-col-reverse relative justify-center items-center custom-bg-drawer bg-gray-50'>
      <img
        src={pokemon.sprites.front_default}
        className='sm:w-full w-20 h-auto scale-[1.5] sm:scale-[2.1]'
      />
